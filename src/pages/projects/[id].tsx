        ...
        <div style={{ maxWidth: 1800, margin: '0 auto', padding: 24 }}>
          ...
          <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: '0 0 57%' }}>
              ...
              <div style={cardStyle}>
                <h2 style={sectionHeaderStyle}>Project Information</h2>
                {editMode ? (
                  /* Edit Form */
                  <div
                    style={{
                  ...
                  >
                    <div>
                      <h3 style={subsectionHeaderStyle}>Basic Information</h3>
                      <div
                        style={{
                          display: 'flex',
                          flexDirection: 'column',
                    ...
                    <div>
                      <h3 style={subsectionHeaderStyle}>Team & Stage</h3>
                      <div
                        style={{
                          display: 'flex',
                          flexDirection: 'column',
                    ...
                    <div>
                      <h3 style={subsectionHeaderStyle}>Timeline</h3>
                      <div
                        style={{
                          display: 'flex',
                          flexDirection: 'column',
                    ...
                    <div>
                      <h3 style={subsectionHeaderStyle}>Financial</h3>
                      <div
                        style={{
                          display: 'flex',
                          flexDirection: 'column',
                  ...
                  >
                    <div>
                      <h3 style={subsectionHeaderStyle}>Team</h3>
                      <div
                        style={{
                          display: 'flex',
                          flexDirection: 'column',
                    ...
                    <div>
                      <h3 style={subsectionHeaderStyle}>Customer</h3>
                      <div
                        style={{
                          display: 'flex',
                          flexDirection: 'column',
                    ...
                    <div>
                      ...
                      >
                        <DetailItem
                          label="Start Date"
                          value={dateStr(project.start_date)}
                        />
                        <DetailItem
                          label="Finish Date"
                          value={dateStr(project.end_date)}
                        />
                      </div>
                    </div>

                    <div>
                      <h3 style={subsectionHeaderStyle}>Subcontractors</h3>
                      <div
                        style={{
                          display: 'flex',
                          flexDirection: 'column',
                          ...
                          >
                            <div style={{ flex: 1 }}>
                              ...
                              {ps.assigned_date && (
                                ...
                                >
                                  Assigned: {dateStr(ps.assigned_date)}
                                </p>
                              )}
                              {ps.notes && (
                                <p
                          ...
                          >
                            ...
                            >
                              <div>
                                ...
                                <select
                                  value={newSubcontractor.subcontractor_id}
                                  onChange={(e) =>
                                    setNewSubcontractor({
                                      ...newSubcontractor,
                              ...
                              <div>
                                ...
                                <input
                                  type="text"
                                  value={newSubcontractor.work_order_number}
                                  onChange={(e) =>
                                    setNewSubcontractor({
                                      ...newSubcontractor,
                              ...
                              <div>
                                ...
                                <input
                                  type="date"
                                  value={newSubcontractor.assigned_date}
                                  onChange={(e) =>
                                    setNewSubcontractor({
                                      ...newSubcontractor,
