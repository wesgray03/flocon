// mark-archived-projects-inactive-production.js
...
async function markArchivedProjectsInactive() {
  try {
    console.log('=== MARKING ARCHIVED PROJECTS AS INACTIVE (PRODUCTION) ===\n');
    ...
    console.log(
      '\n⚠️  PRODUCTION UPDATE - Press Ctrl+C to cancel, or wait 5 seconds to continue...\n'
    );
